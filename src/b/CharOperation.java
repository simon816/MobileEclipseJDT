            ...
            if (var0.length != var3 - var2) {
                ...
                if (var4) {
                    ...
                    while (true) {
                        ...
                        if (class_346.method_3341(var0[var5]) != class_346.method_3341(var1[var5 + var2])) {
                            return false;
                        }
                    }
                }
    ...
    public static final boolean method_1367(char[] var0, char[] var1, boolean var2) {
        if (var2) {
            ...
            if (var0.length != var1.length) {
                ...
                } while (class_346.method_3341(var0[var3]) == class_346.method_3341(var1[var3]));
                return false;
            }
        } else {
            return false;
    ...
    public static final boolean method_1368(char[] var0, char[] var1, int var2, boolean var3) {
        ...
        if (var1.length < var4 + var2) {
            ...
            if (var3) {
                ...
                } while (class_346.method_3341(var0[var5]) == class_346.method_3341(var1[var5 + var2]));
                return false;
            }
        }
    }
        ...
        if (var6 > var4) {
            ...
            if (var6 == var4) {
                if (var2) {
                    ...
                    for (var7 = var3; var7 < var5; ++var7) {
                        if (class_346.method_3341(var1[var7]) != class_346.method_3341(var0[var7])) {
                            return -1;
                        }
                    }
                    return 0;
                ...
                if (var2) {
                    ...
                    label74:
                    for (var8 = var4 - var6 + 1; var7 < var8; ++var7) {
                        if (class_346.method_3341(var1[var7]) == class_346.method_3341(var0[0])) {
                            for (var9 = 1; var9 < var6; ++var9) {
                                if (class_346.method_3341(var1[var7 + var9]) != class_346.method_3341(var0[var9])) {
                                    continue label74;
                                }
                            }
                            return var7;
    ...
    public static final boolean method_1378(char[] var0, int var1, int var2, char[] var3, int var4, int var5, boolean var6) {
        if (var3 == null) {
            ...
            for (var9 = 0; var7 < var2 && (var9 = var0[var7]) != 42; ++var7) {
                ...
                if (var9 != (var6 ? var3[var8] : class_346.method_3341(var3[var8])) && var9 != 63) {
                    return false;
                }
                ++var8;
            }
            ...
            while (var8 < var5) {
                if (var7 == var2) {
                    ...
                    var11 = var8;
                } else if ((var6 ? var3[var8] : class_346.method_3341(var3[var8])) != var9 && var9 != 63) {
                    var7 = var10;
                    ++var11;
                    var8 = var11;
                } else {
