...
import org.eclipse.jdt.internal.compiler.codegen.class_275;
import org.eclipse.jdt.internal.compiler.codegen.class_276;
...
public class class_272 {
    ...
    public int method_2457(byte[] var1, char[] var2) {
        ...
        if ((var3 = this.field_1314.method_1896(var2, this.field_1320)) < 0) {
            if ((var3 = -var3) > '\uffff') {
                this.field_1323.field_1729.field_258.method_644().method_1700(this.field_1323.field_1729.field_258.method_671());
            }
            ++this.field_1320;
            int var4 = this.field_1322.length;
            if (var4 <= var3) {
                System.arraycopy(this.field_1322, 0, this.field_1322 = new int[var3 * 2], 0, var4);
            }
            this.field_1322[var3] = this.field_1321;
            this.method_2477(1);
            int var5 = var1.length;
            if (this.field_1321 + 2 + var5 >= this.field_1319.length) {
                this.method_2476(2 + var5);
            }
            this.field_1319[this.field_1321++] = (byte)(var5 >> 8);
            this.field_1319[this.field_1321++] = (byte)var5;
            System.arraycopy(var1, 0, this.field_1319, this.field_1321, var5);
    ...
    public int method_2458(class_40 var1) {
        ...
        if (var2.method_160()) {
            this.field_1323.method_3012(var2);
        }
    ...
    public int method_2459(char[] var1) {
        ...
        if ((var2 = this.field_1314.method_1896(var1, this.field_1320)) < 0) {
            ...
            int var3 = this.field_1322.length;
            if (var3 <= var2) {
                System.arraycopy(this.field_1322, 0, this.field_1322 = new int[var2 * 2], 0, var3);
            }
            this.field_1322[var2] = this.field_1321;
            this.method_2477(1);
            int var4 = this.field_1321;
            if (this.field_1321 + 2 >= this.field_1319.length) {
                this.method_2476(2);
            }
            this.field_1321 += 2;
            var3 = 0;
            ...
            if (var3 >= '\uffff') {
                ...
                this.field_1323.field_1729.field_258.method_644().method_1698(this.field_1323.field_1729.field_258.method_671());
            }
            if (var2 > '\uffff') {
                this.field_1323.field_1729.field_258.method_644().method_1700(this.field_1323.field_1729.field_258.method_671());
            }
            ++this.field_1320;
            this.field_1319[var4] = (byte)(var3 >> 8);
            this.field_1319[var4 + 1] = (byte)var3;
        }
        return var2;
    }
    ...
    public int method_2460(char[] var1, byte[] var2) {
        ...
        if ((var3 = this.field_1315.method_1896(var1, this.field_1320)) < 0) {
            ...
            this.field_1321 += 2;
            int var6 = this.method_2457(var2, var1);
            this.field_1319[var5++] = (byte)(var6 >> 8);
            this.field_1319[var5] = (byte)var6;
        }
        return var3;
    }
    ...
    public int method_2461(double var1) {
        if (this.field_1310 == null) {
            ...
            this.field_1310 = var10001;
        }
        int var3;
        if ((var3 = this.field_1310.method_2496(var1, this.field_1320)) < 0) {
            if ((var3 = -var3) > '\uffff') {
                this.field_1323.field_1729.field_258.method_644().method_1700(this.field_1323.field_1729.field_258.method_671());
            }
            this.field_1320 += 2;
            ...
            var4 = this.field_1319.length;
            if (this.field_1321 + 8 >= var4) {
                this.method_2476(8);
            }
            this.field_1319[this.field_1321++] = (byte)((int)(var5 >>> 56));
            this.field_1319[this.field_1321++] = (byte)((int)(var5 >>> 48));
            this.field_1319[this.field_1321++] = (byte)((int)(var5 >>> 40));
            this.field_1319[this.field_1321++] = (byte)((int)(var5 >>> 32));
            this.field_1319[this.field_1321++] = (byte)((int)(var5 >>> 24));
            this.field_1319[this.field_1321++] = (byte)((int)(var5 >>> 16));
            this.field_1319[this.field_1321++] = (byte)((int)(var5 >>> 8));
            this.field_1319[this.field_1321++] = (byte)((int)var5);
        }
        return var3;
    }
    ...
    public int method_2462(float var1) {
        if (this.field_1311 == null) {
            ...
            this.field_1311 = var10001;
        }
        int var2;
        if ((var2 = this.field_1311.method_2484(var1, this.field_1320)) < 0) {
            if ((var2 = -var2) > '\uffff') {
                this.field_1323.field_1729.field_258.method_644().method_1700(this.field_1323.field_1729.field_258.method_671());
            }
            ++this.field_1320;
            ...
            if (this.field_1321 + 4 >= this.field_1319.length) {
                this.method_2476(4);
            }
            this.field_1319[this.field_1321++] = (byte)(var4 >>> 24);
            this.field_1319[this.field_1321++] = (byte)(var4 >>> 16);
            this.field_1319[this.field_1321++] = (byte)(var4 >>> 8);
            this.field_1319[this.field_1321++] = (byte)var4;
        }
        return var2;
    }
    ...
    public int method_2463(int var1) {
        if (this.field_1312 == null) {
            ...
            this.field_1312 = var10001;
        }
        int var2;
        if ((var2 = this.field_1312.method_2490(var1, this.field_1320)) < 0) {
            ++this.field_1320;
            if ((var2 = -var2) > '\uffff') {
                this.field_1323.field_1729.field_258.method_644().method_1700(this.field_1323.field_1729.field_258.method_671());
            }
            ...
            this.field_1319[this.field_1321++] = (byte)(var1 >>> 24);
            this.field_1319[this.field_1321++] = (byte)(var1 >>> 16);
            this.field_1319[this.field_1321++] = (byte)(var1 >>> 8);
    ...
    public int method_2464(long var1) {
        if (this.field_1313 == null) {
            ...
            this.field_1313 = var10001;
        }
        int var3;
        if ((var3 = this.field_1313.method_465(var1, this.field_1320)) < 0) {
            if ((var3 = -var3) > '\uffff') {
                this.field_1323.field_1729.field_258.method_644().method_1700(this.field_1323.field_1729.field_258.method_671());
            }
            this.field_1320 += 2;
            ...
            this.field_1322[var3] = this.field_1321;
            this.method_2477(5);
            if (this.field_1321 + 8 >= this.field_1319.length) {
                this.method_2476(8);
            }
            this.field_1319[this.field_1321++] = (byte)((int)(var1 >>> 56));
            this.field_1319[this.field_1321++] = (byte)((int)(var1 >>> 48));
            this.field_1319[this.field_1321++] = (byte)((int)(var1 >>> 40));
            this.field_1319[this.field_1321++] = (byte)((int)(var1 >>> 32));
            this.field_1319[this.field_1321++] = (byte)((int)(var1 >>> 24));
            this.field_1319[this.field_1321++] = (byte)((int)(var1 >>> 16));
            this.field_1319[this.field_1321++] = (byte)((int)(var1 >>> 8));
            this.field_1319[this.field_1321++] = (byte)((int)var1);
        }
        return var3;
    }
    ...
    public int method_2465(String var1) {
        ...
        int var2;
        if ((var2 = this.field_1315.method_1896(var3, this.field_1320)) < 0) {
            ++this.field_1320;
            if ((var2 = -var2) > '\uffff') {
                this.field_1323.field_1729.field_258.method_644().method_1700(this.field_1323.field_1729.field_258.method_671());
            }
            int var4 = this.field_1322.length;
            if (var4 <= var2) {
                System.arraycopy(this.field_1322, 0, this.field_1322 = new int[var2 * 2], 0, var4);
            }
            this.field_1322[var2] = this.field_1321;
            this.method_2477(8);
            int var5 = this.field_1321;
    ...
    public int method_2466(char[] var1) {
        ...
        if ((var2 = this.field_1317.method_1896(var1, this.field_1320)) < 0) {
            ...
            this.field_1319[var4++] = (byte)(var5 >> 8);
            this.field_1319[var4] = (byte)var5;
        }
        return var2;
    }
    ...
    public int method_2468(char[] var1, char[] var2, char[] var3, boolean var4) {
        ...
        if ((var5 = this.method_2474(var1, var2, var3, this.field_1320)) < 0) {
            ...
            int var6 = this.field_1322.length;
            if (var6 <= var5) {
                System.arraycopy(this.field_1322, 0, this.field_1322 = new int[var5 * 2], 0, var6);
            }
            this.field_1322[var5] = this.field_1321;
            ...
            int var9 = this.method_2470(var2, var3);
            this.field_1319[var7++] = (byte)(var8 >> 8);
            this.field_1319[var7++] = (byte)var8;
            this.field_1319[var7++] = (byte)(var9 >> 8);
            this.field_1319[var7] = (byte)var9;
        }
        return var5;
    }
    ...
    public int method_2470(char[] var1, char[] var2) {
        ...
        if ((var3 = this.method_2473(var1, var2, this.field_1320)) < 0) {
            ...
            this.field_1319[var5++] = (byte)(var6 >> 8);
            this.field_1319[var5++] = (byte)var6;
            this.field_1319[var5++] = (byte)(var7 >> 8);
            this.field_1319[var5] = (byte)var7;
        }
        return var3;
    }
    ...
    public int method_2471(char[] var1, char[] var2, char[] var3) {
        ...
        if ((var4 = this.method_2474(var1, var2, var3, this.field_1320)) < 0) {
            ...
            int var5 = this.field_1322.length;
            if (var5 <= var4) {
                System.arraycopy(this.field_1322, 0, this.field_1322 = new int[var4 * 2], 0, var5);
            }
            this.field_1322[var4] = this.field_1321;
            this.method_2477(9);
            ...
            int var8 = this.method_2470(var2, var3);
            this.field_1319[var6++] = (byte)(var7 >> 8);
            this.field_1319[var6++] = (byte)var7;
            this.field_1319[var6++] = (byte)(var8 >> 8);
            this.field_1319[var6] = (byte)var8;
        }
        return var4;
    }
    ...
    public int method_2472(char[] var1) {
        ...
        int var4;
        if ((var4 = this.field_1315.method_1896(var1, this.field_1320)) < 0) {
            if ((var4 = -var4) > '\uffff') {
                this.field_1323.field_1729.field_258.method_644().method_1700(this.field_1323.field_1729.field_258.method_671());
            }
            ++this.field_1320;
            ...
            this.field_1321 += 2;
            int var7;
            if ((var7 = this.field_1314.method_1896(var1, this.field_1320)) < 0) {
                if ((var7 = -var7) > '\uffff') {
                    this.field_1323.field_1729.field_258.method_644().method_1700(this.field_1323.field_1729.field_258.method_671());
                }
                ++this.field_1320;
                var5 = this.field_1322.length;
                if (var5 <= var7) {
                    System.arraycopy(this.field_1322, 0, this.field_1322 = new int[var7 * 2], 0, var5);
                }
                this.field_1322[var7] = this.field_1321;
                this.method_2477(1);
                ...
                for (int var9 = 0; var9 < var1.length; ++var9) {
                    ...
                    if (var10 >= 1 && var10 <= 127) {
                        ...
                        this.field_1319[this.field_1321++] = (byte)var10;
                    } else if (var10 > 2047) {
                        var5 += 3;
                        if (this.field_1321 + 3 >= this.field_1319.length) {
                            this.method_2476(3);
                        }
                        this.field_1319[this.field_1321++] = (byte)(224 | var10 >> 12 & 15);
                        this.field_1319[this.field_1321++] = (byte)(128 | var10 >> 6 & 63);
                        this.field_1319[this.field_1321++] = (byte)(128 | var10 & 63);
                    } else {
                        if (this.field_1321 + 2 >= this.field_1319.length) {
                            this.method_2476(2);
                        }
                        var5 += 2;
                        this.field_1319[this.field_1321++] = (byte)(192 | var10 >> 6 & 31);
                        this.field_1319[this.field_1321++] = (byte)(128 | var10 & 63);
                    }
                }
                if (var5 >= '\uffff') {
                    ...
                    this.field_1315.method_1899(var1);
                    this.field_1314.method_1899(var1);
                    return 0;
                }
                this.field_1319[var8++] = (byte)(var5 >> 8);
                this.field_1319[var8] = (byte)var5;
            }
            this.field_1319[var6++] = (byte)(var7 >> 8);
            this.field_1319[var6] = (byte)var7;
        }
    ...
    private int method_2473(char[] var1, char[] var2, int var3) {
        ...
        class_263 var6;
        if (var5 == null) {
            class_263 var10000 = new class_263(var2, var3);
            var6 = var10000;
            var4 = -var3;
            ...
            if (CharOperation.method_1364(var2, var6.field_1157)) {
                ...
                class_262 var7 = var8;
                var7.method_1896(var6.field_1157, var6.field_1158);
                var4 = var7.method_1896(var2, var3);
                this.field_1318.method_3227(var1, var7);
            }
        } else {
            class_262 var9 = (class_262)var5;
            var4 = var9.method_1896(var2, var3);
        }
        return var4;
    }
    ...
    private int method_2474(char[] var1, char[] var2, char[] var3, int var4) {
        ...
        if (var6 == null) {
            ...
            class_263 var7 = var11;
            var5 = -var4;
            var6.method_3227(var2, var7);
        } else {
            ...
            if (var12 == null) {
                ...
                if (CharOperation.method_1364(var3, var8.field_1157)) {
                    ...
                    class_262 var9 = var10;
                    var9.method_1896(var8.field_1157, var8.field_1158);
                    var5 = var9.method_1896(var3, var4);
                    var6.method_3227(var2, var9);
                }
            } else {
                class_262 var13 = (class_262)var12;
                var5 = var13.method_1896(var3, var4);
            }
        }
        return var5;
    }
    ...
    public void method_2475(int var1, int var2) {
        ...
        if (this.field_1314.method_1895(field_1343) >= var1) {
            this.field_1314.method_1899(field_1343);
        }
    }
    ...
    public void method_2478() {
        ...
        if (this.field_1311 != null) {
            this.field_1311.method_2483();
        }
        if (this.field_1312 != null) {
            this.field_1312.method_2487();
        }
        if (this.field_1313 != null) {
            this.field_1313.method_462();
        }
        this.field_1314.method_1894();
        this.field_1315.method_1894();
        this.field_1316.method_3224();
        this.field_1317.method_1894();
        this.field_1318.method_3224();
        this.field_1320 = 1;
        this.field_1321 = 0;
    }
    ...
    static {
        ...
        field_1403 = new char[][] {class_17.field_26, class_17.field_27, class_17.field_31, "AccessibleObject".toCharArray()};
        field_1404 = new char[][] {class_17.field_26, class_17.field_27, class_17.field_31, "Array".toCharArray()};
