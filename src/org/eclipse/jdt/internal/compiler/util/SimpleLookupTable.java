...
public final class SimpleLookupTable {
    ...
    public SimpleLookupTable(int var1) {
        this.field_1854 = 0;
    ...
    private void rehash() {
        SimpleLookupTable var10000 = new SimpleLookupTable(this.field_1854 * 2);
        SimpleLookupTable var1 = var10000;
        int var3 = this.field_1852.length;
        while (true) {
            --var3;
            if (var3 < 0) {
            ...
            if ((var2 = this.field_1852[var3]) != null) {
                var1.put(var2, this.field_1853[var3]);
            }
        }
    }
