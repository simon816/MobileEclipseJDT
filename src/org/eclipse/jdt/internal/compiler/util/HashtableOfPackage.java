...
public final class HashtableOfPackage {
    ...
    public HashtableOfPackage(int var1) {
        this.elementSize = 0;
        this.threshold = var1;
        ...
        this.valueTable = new PackageBinding[var2];
    }

    public PackageBinding get(char[] var1) {
    ...
    public PackageBinding put(char[] var1, PackageBinding var2) {
    ...
    private void rehash() {
        HashtableOfPackage var10000 = new HashtableOfPackage(this.elementSize * 2);
        HashtableOfPackage var1 = var10000;
        int var3 = this.keyTable.length;
        while (true) {
            --var3;
            if (var3 < 0) {
