...
public class Scanner {
            ...
            for (int var6 = var1 + 2; var6 < var2 && var6 < this.field_1233; ++var6) {
                ...
                if (var5 != 64) {
                    ...
                    for (var9 = 0; var9 < this.field_1252.length; ++var9) {
                        ...
                        var10 = var16.length;
                        if (var10 != 0 && (!ScannerHelper.method_3335(var16[0]) || !ScannerHelper.method_3333(var5))) {
                            for (int var11 = 0; var11 < var10; ++var11) {
                                int var14 = var6 + var11;
                                char var12;
                                char var13;
                                if (var14 >= this.field_1233 || var14 >= var2 || (var12 = var3[var6 + var11]) != (var13 = var16[var11]) && (this.field_1254 || ScannerHelper.method_3341(var12) != ScannerHelper.method_3341(var13))) {
                                    continue label188;
                                }
                            }
                            if (var6 + var10 >= var2 || !ScannerHelper.method_3333(var3[var6 + var10 - 1]) || !ScannerHelper.method_3333(var3[var6 + var10])) {
        ...
        if (this.field_1231 >= this.field_1233) {
            ...
            try {
                ...
                if (var4 >= '\ud800' && var4 <= '\udbff') {
                    ...
                    var5 = ScannerHelper.method_3334(var4, var6);
                } else {
                    if (var4 >= '\udc00' && var4 <= '\udfff') {
                        this.field_1231 = var1;
                        this.field_1239 = var2;
                    ...
                    var5 = ScannerHelper.method_3333(var4);
                }
                if (var3) {
                    if (!var5) {
                        this.field_1231 = var1;
                    ...
                    switch (this.field_1229) {
                        ...
                        default:
                            ...
                            if (var27 >= '\ud800' && var27 <= '\udbff') {
                                ...
                                var9 = ScannerHelper.method_3336(var27, var23);
                            } else {
                                if (var27 >= '\udc00' && var27 <= '\udfff') {
                                    if (this.field_1224 < 3211264L) {
                                        var10000 = new InvalidInputException("Invalid_Unicode_Escape");
                                ...
                                var9 = ScannerHelper.method_3335(var27);
                            }
                            if (var9) {
                                return this.method_2437();
                            }
                        ...
                        try {
                            ...
                            if (var21 < 128) {
                                ...
                                if (var21 >= '\ud800' && var21 <= '\udbff') {
                                    ...
                                    var4 = ScannerHelper.method_3336(var21, var22);
                                } else {
                                    if (var21 >= '\udc00' && var21 <= '\udfff') {
                                        continue;
                                    }
                                    var4 = ScannerHelper.method_3335(var21);
                                }
                                if (var4) {
                                    this.method_2437();
                                }
    ...
    private void method_2430() {
        ...
        while (ScannerHelper.method_3343(this.field_1237[var1])) {
            ++var1;
        }
        if (var2 != var1) {
            Object var4 = null;
