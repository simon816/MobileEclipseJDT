...
import org.eclipse.jdt.internal.compiler.parser.diagnose.class_216;
...
public class LexStream {
    ...
    public LexStream(int var1, Scanner var2, int[] var3, int[] var4, int[] var5, int var6, int var7, int var8) {
        ...
        this.field_911[0].field_921 = CharOperation.field_994;
            ...
            try {
                ...
                if (var3 != 68) {
                    ...
                    if (this.field_914.length != 0 && var6 < this.field_914.length && var4 >= this.field_914[var6]) {
                        ...
                        var7.field_922 = var4;
                        var7.field_923 = var5;
                        var7.field_924 = Util.method_1324(var5, this.field_913.field_1256, 0, this.field_913.field_1257);
                    ...
                    var9.field_920 = var3;
                    var9.field_921 = CharOperation.field_994;
                    var9.field_922 = var4;
                    var9.field_923 = var5;
                    var9.field_924 = Util.method_1324(var5, this.field_913.field_1256, 0, this.field_913.field_1257);
    ...
    public class_216 method_1204(int var1) {
        if (var1 < 0) {
            ...
            class_216 var4 = var5;
            var4.field_920 = 68;
            var4.field_921 = CharOperation.field_994;
            return var4;
