...
import org.eclipse.jdt.internal.compiler.parser.diagnose.DiagnoseParser$SecondaryRepairInfo;
import org.eclipse.jdt.internal.compiler.parser.diagnose.DiagnoseParser$StateInfo;
import org.eclipse.jdt.internal.compiler.parser.diagnose.LexStream;
import org.eclipse.jdt.internal.compiler.parser.diagnose.DiagnoseParser$PrimaryRepairInfo;
import org.eclipse.jdt.internal.compiler.parser.diagnose.DiagnoseParser$RepairCandidate;
...
public class DiagnoseParser {
    ...
    public DiagnoseParser(Parser var1, int var2, int var3, int var4, CompilerOptions var5) {
        this(var1, var2, var3, var4, Util.EMPTY_INT_ARRAY, Util.EMPTY_INT_ARRAY, Util.EMPTY_INT_ARRAY, var5);
    }

    public DiagnoseParser(Parser var1, int var2, int var3, int var4, int[] var5, int[] var6, int[] var7, CompilerOptions var8) {
        ...
        this.parser = var1;
        this.options = var8;
        LexStream var10001 = new LexStream(32, var1.scanner, var5, var6, var7, var2, var3, var4);
        this.lexStream = var10001;
        this.recoveryScanner = var1.recoveryScanner;
    }
    ...
    public void diagnoseParse(boolean var1) {
        this.field_974 = true;
        boolean var2 = false;
        if (this.recoveryScanner != null) {
            var2 = this.recoveryScanner.record;
            this.recoveryScanner.record = var1;
        }
        try {
            this.lexStream.reset();
            this.field_952 = this.lexStream.method_1205();
            int var6 = 731;
            this.reallocateStacks();
            this.field_954 = 0;
            this.field_955[this.field_954] = var6;
            int var7 = this.lexStream.method_1212(this.field_952);
            this.field_956[this.field_954] = this.field_952;
            this.field_957[this.field_954] = this.lexStream.method_1215(this.field_952);
            boolean var8 = false;
            do {
                int var3 = -1;
                this.field_960 = -1;
                ...
                while (var6 > 12828 || var6 < 12827) {
                    ...
                    var5 = this.field_962;
                    this.field_952 = this.lexStream.method_1205();
                    var7 = this.lexStream.method_1212(this.field_952);
                    for (var6 = Parser.method_2517(var6, var7); var6 <= 700; var6 = Parser.method_2517(var6, var7)) {
                        do {
                ...
                if (var6 == 12828) {
                    DiagnoseParser$RepairCandidate var15 = this.errorRecovery(this.field_952, var8);
                    var8 = false;
                    if (this.parser.field_1616) {
                        return;
                    }
                    if (this.parser.problemReporter().options.field_1935 < this.parser.compilationUnit.compilationResult.field_1675) {
                    ...
                    if (var15.field_984 > 110) {
                        ...
                        this.field_957[this.field_954] = this.lexStream.method_1215(var15.field_985);
                    }
                }
            } while (var6 != 12827);
        } finally {
            if (this.recoveryScanner != null) {
                this.recoveryScanner.record = var2;
            }
        }
    }

    private static char[] displayEscapeCharacters(char[] var0, int var1, int var2) {
    ...
    private DiagnoseParser$RepairCandidate errorRecovery(int var1, boolean var2) {
        this.field_950 = var1;
        this.field_951 = this.lexStream.method_1215(var1);
        int var3 = this.lexStream.method_1206(var1);
        int var4 = this.lexStream.method_1212(var3);
        if (var2) {
            char var8 = Parser.field_1555[69];
            this.method_1307(3, var8, var3, var3);
            DiagnoseParser$RepairCandidate var10000 = new DiagnoseParser$RepairCandidate();
            DiagnoseParser$RepairCandidate var9 = var10000;
            var9.field_984 = 69;
            var9.field_985 = var1;
            this.lexStream.reset(var1);
            this.field_954 = this.field_962;
            for (int var7 = 0; var7 <= this.field_954; ++var7) {
                this.field_955[var7] = this.field_963[var7];
            }
            this.field_956[this.field_954] = var1;
            this.field_957[this.field_954] = this.lexStream.method_1215(var1);
            return var9;
        } else {
            DiagnoseParser$RepairCandidate var5 = this.method_1291(var1);
            if (var5.field_984 != 0) {
                return var5;
            } else {
                ...
                if (var5.field_984 != 0) {
                    return var5;
                } else if (this.lexStream.method_1212(var1) == 68) {
                    this.method_1307(11, Parser.field_1555[68], var3, var3);
                    var5.field_984 = 0;
                    var5.field_985 = var1;
                    return var5;
                } else {
                    while (this.lexStream.method_1212(this.field_968[31]) != 68) {
                    ...
                    int var6;
                    for (var6 = 31; this.lexStream.method_1212(this.field_968[var6]) == 68; --var6) {
                        ;
                    }
    ...
    private DiagnoseParser$RepairCandidate method_1291(int var1) {
        DiagnoseParser$PrimaryRepairInfo var10000 = new DiagnoseParser$PrimaryRepairInfo();
        DiagnoseParser$PrimaryRepairInfo var2 = var10000;
        DiagnoseParser$RepairCandidate var7 = new DiagnoseParser$RepairCandidate();
        DiagnoseParser$RepairCandidate var3 = var7;
        int var4 = this.field_962 >= 0 ? 3 : 2;
        this.field_968[var4] = var1;
        int var5;
        for (var5 = var4; var5 > 0; --var5) {
            this.field_968[var5 - 1] = this.lexStream.method_1206(this.field_968[var5]);
        }
        for (var5 = var4 + 1; var5 < 32; ++var5) {
            this.field_968[var5] = this.lexStream.method_1207(this.field_968[var5 - 1]);
        }
        if (this.field_962 >= 0) {
            var2.field_978 = 3;
            var2 = this.method_1293(this.field_963, this.field_962, var2);
        }
        DiagnoseParser$PrimaryRepairInfo var8 = var2.copy();
        var8.field_978 = 2;
        ...
        if (this.field_962 >= 0) {
            if (this.secondaryCheck(this.field_963, this.field_962, 3, var2.field_975)) {
                return var3;
            }
        } else if (this.secondaryCheck(this.field_955, this.field_954, 2, var2.field_975)) {
            return var3;
        }
        ...
        if (var2.field_975 < 3) {
            ...
            if (var2.field_978 == 1) {
                ...
                this.field_957[this.field_954] = this.lexStream.method_1215(this.field_968[3]);
            }
            return this.primaryDiagnosis(var2);
        }
    }

    private int method_1292(int var1, int var2) {
        char[] var3 = this.lexStream.name(this.field_968[var2]);
        char[] var4 = this.lexStream.name(this.field_968[var2 + 1]);
        int var5 = var3.length + var4.length;
        char[] var6 = CharOperation.concat(var3, var4);
    ...
    private DiagnoseParser$PrimaryRepairInfo method_1293(int[] var1, int var2, DiagnoseParser$PrimaryRepairInfo var3) {
        DiagnoseParser$PrimaryRepairInfo var13 = this.method_1299(var1, var2, var3.copy());
        ...
        var5 = this.method_1306(var1, var2, this.lexStream.method_1212(this.field_968[var3.field_978 + 1]), var3.field_978 + 2);
        byte var6;
        if (this.lexStream.method_1212(this.field_968[var3.field_978]) == 68 && this.lexStream.method_1208(this.field_968[var3.field_978 + 1])) {
            var6 = 10;
        } else {
            var6 = 0;
        }
        ...
        int var12 = this.lexStream.method_1212(this.field_968[var3.field_978]);
        this.lexStream.reset(this.field_968[var3.field_978 + 1]);
        char var15;
        ...
        for (var11 = var4; var11 != 0; var11 = this.field_967[var11]) {
            if (var11 == 68 && this.lexStream.method_1208(this.field_968[var3.field_978])) {
                var6 = 10;
            } else {
                var6 = 0;
            }
        ...
        if (this.field_968[var3.field_978] != 0) {
            while (var11 != 0) {
                int var14;
                if (var11 == 68 && this.lexStream.method_1208(this.field_968[var3.field_978 + 1])) {
                    var14 = 10;
                } else {
    ...
    private DiagnoseParser$RepairCandidate primaryDiagnosis(DiagnoseParser$PrimaryRepairInfo var1) {
        ...
        switch (var1.field_977) {
            ...
            case 3:
                if (var1.field_979 > 110) {
                    var2 = this.getNtermIndex(this.field_955[this.field_954], var1.field_979, var1.field_978);
                } else {
                ...
                break;
            case 4:
                var2 = this.getNtermIndex(this.field_955[this.field_954], var1.field_979, var1.field_978 + 1);
            ...
            default:
                ...
                break;
            case 7:
                this.method_1307(var1.field_977, Parser.field_1555[var1.field_979], var4, this.lexStream.method_1207(var4));
                break;
            case 9:
                ...
                this.method_1308(var1.field_977, -this.field_965[this.field_964], this.field_956[this.field_966[this.field_964]], var3, this.getNtermIndex(this.field_955[this.field_954], var1.field_979, var1.field_978));
        }
        DiagnoseParser$RepairCandidate var10000 = new DiagnoseParser$RepairCandidate();
        DiagnoseParser$RepairCandidate var6 = var10000;
        switch (var1.field_977) {
            case 2:
            case 3:
            case 9:
                ...
                this.lexStream.reset(this.field_968[var1.field_978]);
                break;
            case 4:
            case 5:
                var6.field_984 = var1.field_979;
                var6.field_985 = this.field_968[var1.field_978];
                this.lexStream.reset(this.field_968[var1.field_978 + 1]);
                break;
            case 6:
            case 8:
            default:
                var6.field_985 = this.field_968[var1.field_978 + 1];
                var6.field_984 = this.lexStream.method_1212(this.field_968[var1.field_978 + 1]);
                this.lexStream.reset(this.field_968[var1.field_978 + 2]);
                break;
            case 7:
                var6.field_984 = var1.field_979;
                var6.field_985 = this.field_968[var1.field_978];
    ...
    private int method_1295(int[] var1, int var2, int var3, int var4) {
        ...
        int var7 = var3;
        this.field_958 = var2 - 1;
        this.lexStream.reset(this.field_968[var4]);
        ...
        var3 = this.lexStream.method_1212(this.field_968[var4]);
        this.lexStream.reset(this.field_968[var4 + 1]);
        if (var5 > 12828) {
            var5 -= 12828;
        } else {
            this.field_959[this.field_958 + 1] = var5;
    ...
    private int getNtermIndex(int var1, int var2, int var3) {
        int var4 = var2 - 110;
        int var5 = this.lexStream.method_1212(this.field_968[var3]);
        this.lexStream.reset(this.field_968[var3 + 1]);
        this.field_958 = 0;
    ...
    private int method_1298(int var1, int var2) {
        ...
        var5[var4] = 0;
        char[] var15 = this.lexStream.name(var2);
    ...
    private DiagnoseParser$PrimaryRepairInfo method_1299(int[] var1, int var2, DiagnoseParser$PrimaryRepairInfo var3) {
        this.field_969 = new int[this.field_953];
        for (int var4 = 0; var4 < this.field_953; ++var4) {
            this.field_969[var4] = -1;
        }
        this.statePoolTop = 0;
        this.statePool = new DiagnoseParser$StateInfo[this.field_953];
        this.scopeTrialCheck(var1, var2, var3, 0);
        this.field_969 = null;
        this.statePoolTop = 0;
        var3.field_977 = 9;
        var3.field_976 = 10;
    ...
    private void scopeTrialCheck(int[] var1, int var2, DiagnoseParser$PrimaryRepairInfo var3, int var4) {
        if (var4 <= 20) {
            int var5 = var1[var2];
            int var6;
            for (var6 = this.field_969[var2]; var6 != -1; var6 = this.statePool[var6].field_903) {
                if (this.statePool[var6].field_902 == var5) {
                    return;
                }
            }
            var6 = this.statePoolTop++;
            ...
            DiagnoseParser$StateInfo[] var10000 = this.statePool;
            DiagnoseParser$StateInfo var10002 = new DiagnoseParser$StateInfo(var5, this.field_969[var2]);
            ...
            for (int var7 = 0; var7 < 134; ++var7) {
                ...
                this.lexStream.reset(this.field_968[var3.field_978]);
                        ...
                        if (Parser.field_1550[var17] != 0) {
                            ...
                            if (var15 - var3.field_978 + 1 < 3) {
                                ...
                                for (var5 = Parser.method_2509(var1[var13], Parser.field_1547[var7]); var5 <= 700; var5 = Parser.method_2509(var1[var16], Parser.field_1534[var5])) {
                                    if (Parser.rules_compliance[var5] > this.options.field_1928) {
                                        continue label134;
                                    }
                                ...
                                var5 = var1[var16];
                                var1[var16] = var17;
                                this.scopeTrialCheck(var1, var16, var3, var4 + 1);
                                var1[var16] = var5;
                            } else if (var15 > var3.field_975) {
                                this.field_964 = var4;
                                var3.field_975 = var15;
                            }
                            if (this.lexStream.method_1212(this.field_968[var3.field_978]) == 68 && var3.field_975 == var14) {
                                this.field_964 = var4;
                                var3.field_975 = 30;
                            }
    ...
    private boolean secondaryCheck(int[] var1, int var2, int var3, int var4) {
        for (int var5 = var2 - 1; var5 >= 0; --var5) {
            int var6 = this.method_1306(var1, var5, this.lexStream.method_1212(this.field_968[var3]), var3 + 1);
            if (var6 - var3 + 1 > 3 && var6 > var4) {
                return true;
            }
        }
        DiagnoseParser$PrimaryRepairInfo var10000 = new DiagnoseParser$PrimaryRepairInfo();
        DiagnoseParser$PrimaryRepairInfo var7 = var10000;
    ...
    private DiagnoseParser$RepairCandidate method_1302(int var1) {
        DiagnoseParser$SecondaryRepairInfo var10000 = new DiagnoseParser$SecondaryRepairInfo();
        DiagnoseParser$SecondaryRepairInfo var2 = var10000;
        var10000 = new DiagnoseParser$SecondaryRepairInfo();
        DiagnoseParser$SecondaryRepairInfo var3 = var10000;
        DiagnoseParser$RepairCandidate var15 = new DiagnoseParser$RepairCandidate();
        DiagnoseParser$RepairCandidate var4 = var15;
        int var9 = 0;
        var4.field_984 = 0;
        var2.field_892 = 0;
        var2.field_893 = 0;
        var2.recoveryOnNextStack = false;
        var3.field_893 = 0;
        var3.recoveryOnNextStack = false;
        int var7;
        if (this.field_962 >= 0) {
            this.field_968[2] = var1;
            this.field_968[1] = this.lexStream.method_1206(this.field_968[2]);
            this.field_968[0] = this.lexStream.method_1206(this.field_968[1]);
            for (var7 = 3; var7 < 31; ++var7) {
                this.field_968[var7] = this.lexStream.method_1207(this.field_968[var7 - 1]);
            }
            this.field_968[31] = this.lexStream.method_1211();
            for (var9 = 29; var9 >= 1 && this.lexStream.method_1212(this.field_968[var9]) == 68; --var9) {
                ;
            }
            ++var9;
        ...
        this.field_968[2] = this.lexStream.method_1206(this.field_968[3]);
        this.field_968[1] = this.lexStream.method_1206(this.field_968[2]);
        this.field_968[0] = this.lexStream.method_1206(this.field_968[1]);
        ...
        int var10;
        for (var10 = 29; var10 >= 1 && this.lexStream.method_1212(this.field_968[var10]) == 68; --var10) {
            ;
        }
        ++var10;
        ...
        if (var3.field_893 > 3 && (var3.field_896 <= var2.field_896 || var3.field_893 - var3.field_896 >= var2.field_893 - var2.field_896)) {
            ...
            var2.recoveryOnNextStack = var3.recoveryOnNextStack;
        }
        int var5;
        if (var2.recoveryOnNextStack) {
            this.field_954 = this.field_962;
        ...
        DiagnoseParser$PrimaryRepairInfo var13;
        DiagnoseParser$PrimaryRepairInfo var14;
        if (var2.field_892 == 10 || var2.field_892 == 6) {
            var14 = new DiagnoseParser$PrimaryRepairInfo();
            var13 = var14;
            var13.field_975 = 0;
        ...
        if (var2.field_892 == 0 && this.lexStream.method_1212(this.field_968[var10]) == 68) {
            var14 = new DiagnoseParser$PrimaryRepairInfo();
            var13 = var14;
        ...
        if (var2.field_892 == 0) {
            ...
            this.secondaryDiagnosis(var2);
            switch (var2.field_892) {
                case 6:
                    var4.field_985 = this.field_968[var2.field_894];
                    var4.field_984 = this.lexStream.method_1212(this.field_968[var2.field_894]);
                    this.lexStream.reset(this.lexStream.method_1207(this.field_968[var2.field_894]));
                    break;
                case 8:
                    var4.field_985 = this.field_968[2];
                    var4.field_984 = this.lexStream.method_1212(this.field_968[2]);
                    this.lexStream.reset(this.lexStream.method_1207(this.field_968[2]));
                    break;
                default:
                    var4.field_984 = var2.field_897;
                    var4.field_985 = this.field_968[var2.field_894];
                    this.lexStream.reset(this.field_968[var2.field_894]);
            }
            return var4;
        }
    }

    private DiagnoseParser$SecondaryRepairInfo method_1303(int[] var1, int var2, int var3, DiagnoseParser$SecondaryRepairInfo var4, boolean var5) {
        ...
        for (int var8 = var2 - 1; var8 >= 0; --var8) {
            ...
            int var9 = this.method_1306(var1, var8, this.lexStream.method_1212(this.field_968[2]), 3);
            if (var9 == 30) {
                var9 = var3;
            }
            if (var9 > 3 && var9 - var7 > var4.field_893 - var4.field_896) {
                ...
                var4.field_893 = var9;
                var4.field_896 = var7;
                var4.recoveryOnNextStack = var5;
            }
        }
        return var4;
    }

    private DiagnoseParser$SecondaryRepairInfo method_1304(int[] var1, int var2, int var3, DiagnoseParser$SecondaryRepairInfo var4, boolean var5) {
        int var7 = 0;
        int var6 = this.field_968[2];
        for (int var8 = var2; var8 >= 0 && var4.field_896 >= var7; --var8) {
            ...
            for (int var9 = 2; var9 <= var3 - 3 + 1 && var4.field_896 >= var7 + var9 - 1; ++var9) {
                int var10 = this.method_1306(var1, var8, this.lexStream.method_1212(this.field_968[var9]), var9 + 1);
                if (var10 == 30) {
                    var10 = var3;
                }
                int var11;
    ...
    private void secondaryDiagnosis(DiagnoseParser$SecondaryRepairInfo var1) {
        switch (var1.field_892) {
            case 9:
                ...
                this.field_954 = this.field_966[this.field_964];
                this.method_1308(9, -this.field_965[this.field_964], this.field_956[this.field_966[this.field_964]], this.field_968[1], this.getNtermIndex(this.field_955[this.field_954], var1.field_897, var1.field_894));
                break;
            default:
                this.method_1307(var1.field_892, var1.field_892 == 10 ? this.getNtermIndex(this.field_955[var1.field_895], var1.field_897, var1.field_894) : Parser.field_1555[110], this.field_956[var1.field_895], this.field_968[var1.field_894 - 1]);
    ...
    private int method_1306(int[] var1, int var2, int var3, int var4) {
        ...
        if (var3 > 110) {
            ...
            var5 = var2;
            var6 = var4;
            var7 = this.lexStream.method_1212(this.field_968[var4]);
            this.lexStream.reset(this.lexStream.method_1207(this.field_968[var4]));
            int var9 = var3 - 110;
            ...
            if (var8 <= 700) {
                while (true) {
                    ...
                    if (Parser.rules_compliance[var8] > this.options.field_1928) {
                        return 0;
                    }
        ...
        while (true) {
            ...
            if (var8 <= 700) {
                ...
                ++var6;
                var7 = this.lexStream.method_1212(this.field_968[var6]);
                this.lexStream.reset(this.lexStream.method_1207(this.field_968[var6]));
                if (var8 <= 12828) {
                    if (this.field_947) {
            ...
            do {
                ...
                if (var8 <= 700 && Parser.rules_compliance[var8] > this.options.field_1928) {
                    return 0;
                }
                var10 = Parser.field_1534[var8];
                var8 = this.field_958 > var5 ? this.field_959[this.field_958] : var1[this.field_958];
    ...
    private void method_1309(int var1, int var2, int var3, int var4) {
        ...
        int var6 = this.lexStream.method_1215(var3);
        int var7 = this.lexStream.method_1216(var3);
        int var8 = this.lexStream.method_1212(var3);
        String var9 = Parser.field_1535[Parser.field_1555[this.lexStream.method_1212(var3)]];
        char[] var10 = this.lexStream.name(var3);
        if (var8 == 52) {
            var10 = displayEscapeCharacters(var10, 1, var10.length - 1);
        }
        int var11 = -1;
        if (this.recoveryScanner != null && var2 >= 0) {
            var11 = Parser.reverse_index[var2];
        }
        int[] var21;
        int[] var20;
        switch (var1) {
            case 2:
                if (this.recoveryScanner != null) {
                    if (var11 > -1) {
                        this.recoveryScanner.method_2446(var11, -1, var6);
                    } else {
                        var20 = this.getNTermTemplate(-var11);
                        if (var20 != null) {
                            this.recoveryScanner.method_2448(var20, -1, var6);
                        }
                    }
                }
                if (this.field_974) {
                    this.problemReporter().method_1726(var6, var7, var8, var10, var9, var5);
                }
                break;
            case 3:
                if (this.recoveryScanner != null) {
                    if (var11 > -1) {
                        this.recoveryScanner.method_2446(var11, -1, var7);
                    } else {
                        var20 = this.getNTermTemplate(-var11);
                        if (var20 != null) {
                            this.recoveryScanner.method_2448(var20, -1, var7);
                        }
                    }
                }
                if (this.field_974) {
                    this.problemReporter().method_1725(var6, var7, var8, var10, var9, var5);
                }
                break;
            case 4:
                if (var5.length() == 0) {
                    if (this.recoveryScanner != null) {
                        this.recoveryScanner.removeTokens(var6, var7);
                    }
                    if (this.field_974) {
                        this.problemReporter().method_1735(var6, var7, var8, var10, var9, var5);
                    }
                } else {
                    if (this.recoveryScanner != null) {
                        if (var11 > -1) {
                            this.recoveryScanner.method_2449(var11, var6, var7);
                        } else {
                            var20 = this.getNTermTemplate(-var11);
                            if (var20 != null) {
                                this.recoveryScanner.method_2450(var20, var6, var7);
                            }
                        }
                    }
                    if (this.field_974) {
                        this.problemReporter().method_1730(var6, var7, var8, var10, var9, var5);
                    }
                }
                break;
            case 5:
            ...
            case 6:
                ...
                if (this.field_974) {
                    this.problemReporter().method_1723(var6, var7, var8, var10, var9);
                }
                break;
            case 7:
                if (this.recoveryScanner != null) {
                    if (var11 > -1) {
                        ...
                        var21 = this.getNTermTemplate(-var11);
                        if (var21 != null) {
                            this.recoveryScanner.method_2450(var21, var6, var7);
                        }
                    }
                }
                if (this.field_974) {
                    this.problemReporter().method_1731(var6, var7, var5);
                }
                break;
            case 8:
                if (this.recoveryScanner != null) {
                ...
                if (this.field_974) {
                    this.problemReporter().method_1732(var6, var7);
                }
                break;
            case 9:
                ...
                for (var15 = Parser.field_1552[-var2]; Parser.field_1549[var15] != 0; ++var15) {
                    ...
                    if (var13 != null) {
                        int var16 = Parser.reverse_index[Parser.field_1549[var15]];
                        if (var16 > -1) {
                            ...
                            int[] var22 = this.getNTermTemplate(-var16);
                            if (var22 != null) {
                ...
                if (var14 > 0) {
                    ...
                    var15 = -1;
                    if (var4 != 0) {
                        var15 = -Parser.reverse_index[var4];
                    }
                    this.recoveryScanner.method_2448(var13, var15, var7);
                }
                if (var4 != 0) {
                    if (this.field_974) {
                        this.problemReporter().parseErrorInsertToComplete(var6, var7, var12.toString(), Parser.field_1539[var4]);
                    }
                } else if (this.field_974) {
                    this.problemReporter().method_1729(var6, var7, var12.toString());
                }
                break;
            case 10:
            default:
                if (var5.length() == 0) {
                    ...
                    if (this.field_974) {
                        this.problemReporter().method_1733(var6, var7, var8, var10, var9);
                    }
                } else {
                    if (this.recoveryScanner != null) {
                        if (var11 > -1) {
            ...
            case 11:
                if (this.field_974) {
                    this.problemReporter().method_1737(var6, var7);
                }
        }
    }
    ...
    private void method_1310(int var1, int var2, int var3, int var4, int var5) {
        ...
        int var7 = -1;
        int var8;
        if (this.lexStream.method_1217(var3)) {
            if (var3 == 0) {
                var7 = this.lexStream.method_1215(var3 + 1);
            } else {
                var7 = this.lexStream.method_1215(var3);
            }
        } else {
            ...
            if (var7 == -1) {
                var7 = this.lexStream.method_1215(var4);
            }
        }
        var8 = this.lexStream.method_1216(var4);
        int var9 = -1;
        if (this.recoveryScanner != null && var2 >= 0) {
            var9 = Parser.reverse_index[var2];
        }
        int[] var19;
        switch (var1) {
            case 6:
                if (this.recoveryScanner != null) {
                    this.recoveryScanner.removeTokens(var7, var8);
                }
                if (this.field_974) {
                    this.problemReporter().method_1724(var7, var8);
                }
                break;
            case 7:
                if (this.recoveryScanner != null) {
                    if (var9 > -1) {
                        this.recoveryScanner.method_2449(var9, var7, var8);
                    } else {
                        var19 = this.getNTermTemplate(-var9);
                        if (var19 != null) {
                            this.recoveryScanner.method_2450(var19, var7, var8);
                        }
                    }
                }
                if (this.field_974) {
                    this.problemReporter().method_1731(var7, var8, var6);
                }
                break;
            case 8:
                if (this.recoveryScanner != null) {
                ...
                if (this.field_974) {
                    this.problemReporter().method_1732(var7, var8);
                }
                break;
            case 9:
                var7 = this.lexStream.method_1215(var4);
                ...
                for (var13 = Parser.field_1552[-var2]; Parser.field_1549[var13] != 0; ++var13) {
                    ...
                    if (var11 != null) {
                        int var14 = Parser.reverse_index[Parser.field_1549[var13]];
                        if (var14 > -1) {
                            ...
                            int[] var18 = this.getNTermTemplate(-var14);
                            if (var18 != null) {
                ...
                if (var12 > 0) {
                    ...
                    var13 = -1;
                    if (var5 != 0) {
                        var13 = -Parser.reverse_index[var5];
                    }
                    this.recoveryScanner.method_2448(var11, var13, var8);
                }
                if (var5 != 0) {
                    if (this.field_974) {
                        this.problemReporter().parseErrorInsertToComplete(var7, var8, var10.toString(), Parser.field_1539[var5]);
                    }
                } else if (this.field_974) {
                    this.problemReporter().method_1728(var7, var8, var10.toString());
                }
                break;
            default:
                if (var6.length() == 0) {
                    ...
                    if (this.field_974) {
                        this.problemReporter().method_1734(var7, var8);
                    }
                } else {
                    if (this.recoveryScanner != null) {
                        if (var9 > -1) {
                    ...
                    if (this.field_974) {
                        this.problemReporter().method_1736(var7, var8, var6);
                    }
                }
        }
    }

    private int[] getNTermTemplate(int var1) {
    ...
    public String toString() {
        ...
        var1.append(this.lexStream.toString());
