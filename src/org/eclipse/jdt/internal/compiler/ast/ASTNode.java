...
public abstract class ASTNode implements class_17 {
    ...
    public static void method_749(class_86 var0, class_126 var1, class_40 var2, class_58 var3, class_126[] var4, class_40[] var5, boolean var6, InvocationSite var7) {
        ...
        if (var4 == null) {
            if (var3.method_374()) {
                ...
                if (!var13.method_167()) {
                    var0.method_644().method_1801(var13, (ASTNode)var7);
                }
            }
        } else {
            int var20;
            if (var3.method_374()) {
                ...
                if (var20 < var14) {
                    ...
                    if (var9 != var14 || var15.method_136() != var5[var20].method_136()) {
                        ...
                        if (!var15.method_167()) {
                            var0.method_644().method_1801(var15, (ASTNode)var7);
                        }
        ...
        if ((var19 & 2) != 0) {
            var0.method_644().method_1825((ASTNode)var7, var2, var3, var5);
        } else if (!var3.method_370() && !var2.method_170() && var3.field_278.method_166() && var3.method_354()) {
            var0.method_644().method_1804((ASTNode)var7, var3);
        } else if (var11 != null) {
            var0.method_644().method_1803((ASTNode)var7, var3);
        }
    }
    ...
    public final boolean method_751(class_67 var1, class_83 var2, boolean var3) {
        ...
        if ((var1.field_300 & 262144) != 0) {
            AccessRestriction var4 = var2.method_586().method_503(var1.field_314.method_138());
            if (var4 != null) {
    ...
    public final boolean method_753(class_58 var1, class_83 var2, boolean var3) {
        ...
        if (var3 && (var1.field_273 & 262144) != 0) {
            AccessRestriction var4 = var2.method_586().method_503(var1.field_278.method_138());
            if (var4 != null) {
    ...
    public final boolean method_756(class_40 var1, class_83 var2) {
        ...
        if (var1.method_148()) {
            ...
            if ((this.field_446 & '\u8000') == 0 && (var3.method_223() || var3.method_158()) && !var2.method_628(var3)) {
                ReferenceBinding var10000 = (ReferenceBinding)var3.method_138();
                var10000.field_199 |= 134217728;
            }
            if (var3.method_214()) {
                AccessRestriction var4 = var2.method_586().method_503(var1.method_138());
                if (var4 != null) {
        ...
        if (var1 != null) {
            ...
            if (var3 != null) {
                ...
                for (int var14 = 0; var14 < var4; ++var14) {
                    ...
                    if (var17 != null) {
                        ReferenceBinding var19 = var17.method_1182();
                        boolean var20 = false;
