...
public class AND_AND_Expression extends BinaryExpression {
    ...
    public AND_AND_Expression(Expression var1, Expression var2, int var3) {
    ...
    public FlowInfo analyseCode(BlockScope var1, FlowContext var2, FlowInfo var3) {
        ...
        if (var5) {
            ...
            this.field_719 = var1.method_635().recordInitializationStates(var7);
            return var7;
        } else {
            var7 = this.field_715.analyseCode(var1, var2, var3);
            UnconditionalFlowInfo var8 = var7.method_3081().method_3107();
            this.field_718 = var1.method_635().recordInitializationStates(var8);
            int var9 = var8.reachMode();
            if (var6) {
                var8.setReachMode(1);
            }
            FlowInfo var12 = this.field_716.analyseCode(var1, var2, var8);
            FlowInfo var10 = FlowInfo.conditional(var12.method_3103(), var7.method_3080().method_3109().mergedWith(var12.method_3080().setReachMode(var9).method_3109()));
            this.field_719 = var1.method_635().recordInitializationStates(var10);
            return var10;
        }
    }
            ...
            if (var5 != Constant.NotAConstant) {
                ...
                label108: {
                    ...
                    if (var8) {
                        ...
                        this.field_715.generateOptimizedBoolean(var1, var2, (BranchLabel)null, var6, true);
                    }
                    if (this.field_718 != -1) {
                    ...
                    if (var10) {
                        ...
                        this.field_716.generateOptimizedBoolean(var1, var2, (BranchLabel)null, var6, var3);
                    }
                }
                if (this.field_719 != -1) {
                    var2.method_2363(var1, this.field_719);
            ...
            if (var6 != Constant.NotAConstant && var6.booleanValue()) {
                ...
                if (var4 == null) {
                    if (var3 != null) {
                        ...
                        this.field_715.generateOptimizedBoolean(var1, var2, (BranchLabel)null, var11, !var7);
                        if (var7 && !var8) {
                            var11.place();
                        } else {
                            if (this.field_718 != -1) {
                    ...
                    this.field_715.generateOptimizedBoolean(var1, var2, (BranchLabel)null, var4, !var7);
                    if (var7 && !var8) {
                        if (var5) {
