...
public class BreakStatement extends BranchStatement {
    ...
    public BreakStatement(char[] var1, int var2, int var3) {
        super(var1, var2, var3);
    }

    public FlowInfo analyseCode(BlockScope var1, FlowContext var2, FlowInfo var3) {
        FlowContext var4 = this.label == null ? var2.method_3037() : var2.method_3035(this.label);
        if (var4 == null) {
            if (this.label == null) {
                var1.problemReporter().method_1623(this);
            } else {
            ...
            this.targetLabel = var4.breakLabel();
