...
import org.eclipse.jdt.internal.compiler.lookup.class_68;
...
public class SourceTypeBinding extends ReferenceBinding {
    ...
    public ReferenceBinding field_252;
    ...
    public SourceTypeBinding(char[][] var1, PackageBinding var2, class_84 var3) {
        this.field_261 = null;
        this.field_197 = var1;
        this.field_200 = var2;
    ...
    private void method_292() {
        if ((this.field_178 & 1024L) == 0L) {
            ...
            if (this.method_151() && this.method_217()) {
                ...
                ReferenceBinding[] var1 = this.method_241();
                if (var1 != class_34.field_155) {
                    ...
                    if (var3 > 0) {
                        ...
                        var6 += var3;
                        if (var6 > 1) {
                            ReferenceBinding.method_193(this.field_255, 0, var6);
                        }
                    }
                }
            }
    ...
    public class_67 method_294(ReferenceBinding var1) {
        if (this.field_259 == null) {
            this.field_259 = new HashMap[4];
        }
        if (this.field_259[1] == null) {
        ...
        if ((this.field_178 & 8192L) != 0L) {
            ...
            try {
                ...
                if ((this.field_178 & 4096L) == 0L) {
                    ...
                    if (var3 > 1) {
                        ReferenceBinding.method_192(this.field_254, 0, var3);
                    }
    ...
    public long method_99() {
        if ((this.field_178 & 8589934592L) == 0L && this.field_258 != null) {
            ...
            try {
                ...
                ASTNode.method_761(var1.field_589, var1.field_579, this);
            } finally {
    ...
    public class_58 method_206(class_40[] var1) {
        ...
        if ((this.field_178 & 32768L) != 0L) {
            if ((var3 = ReferenceBinding.method_190(class_17.field_135, this.field_255)) >= 0L) {
                var5 = (int)var3;
                label60:
            ...
            if ((this.field_178 & 16384L) == 0L) {
                ...
                if (var10 > 1) {
                    ReferenceBinding.method_193(this.field_255, 0, var10);
                }
    ...
    public class_58 method_207(char[] var1, class_40[] var2, class_85 var3) {
        ...
        int var9;
        if ((this.field_178 & 32768L) != 0L) {
            if ((var6 = ReferenceBinding.method_190(var1, this.field_255)) >= 0L) {
                var8 = (int)var6;
                label119:
            ...
            if ((this.field_178 & 16384L) == 0L) {
                ...
                if (var16 > 1) {
                    ReferenceBinding.method_193(this.field_255, 0, var16);
                }
                this.field_178 |= 16384L;
            }
            if ((var6 = ReferenceBinding.method_190(var1, this.field_255)) >= 0L) {
    ...
    public class_67 method_208(char[] var1, boolean var2) {
        if ((this.field_178 & 8192L) != 0L) {
            return ReferenceBinding.method_189(var1, this.field_254);
        } else {
            if ((this.field_178 & 4096L) == 0L) {
            ...
            class_67 var16 = ReferenceBinding.method_189(var1, this.field_254);
            if (var16 != null) {
                class_67 var4 = null;
                class_67 var5;
                try {
    ...
    public class_58[] method_210(char[] var1) {
        ...
        if ((this.field_178 & 32768L) != 0L) {
            long var12;
            if ((var12 = ReferenceBinding.method_190(var1, this.field_255)) >= 0L) {
                int var4 = (int)var12;
                var5 = (int)(var12 >> 32);
                var6 = var5 - var4 + 1;
                class_58[] var14;
            ...
            if ((this.field_178 & 16384L) == 0L) {
                int var2 = this.field_255.length;
                if (var2 > 1) {
                    ReferenceBinding.method_193(this.field_255, 0, var2);
                }
                this.field_178 |= 16384L;
            }
            long var3;
            if ((var3 = ReferenceBinding.method_190(var1, this.field_255)) < 0L) {
                return class_34.field_154;
            } else {
                var5 = (int)var3;
                var6 = (int)(var3 >> 32);
    ...
    public class_67 method_310(ReferenceBinding var1, boolean var2) {
    ...
    public void method_100() {
        if ((this.field_178 & 17179869184L) == 0L) {
            ...
            try {
                var1.field_589.field_412 = true;
                ASTNode.method_762(var1.field_589, var1.field_579, this);
                ...
                case 260:
                    if ((var1.field_178 & 1073741824L) == 0L && (!this.method_159() || !var1.method_159())) {
                        ...
                        if (this != var2.method_286()) {
                            ...
                            if (!this.method_226()) {
                                ReferenceBinding var3 = this.method_137();
                                if (var3 != null) {
    ...
    public class_67 method_311(class_67 var1, ReferenceBinding var2) {
        if (this.field_259 == null) {
            this.field_259 = new HashMap[4];
        }
    ...
    public class_58 method_312(class_58 var1, ReferenceBinding var2) {
        if (this.field_259 == null) {
            this.field_259 = new HashMap[4];
        }
        if (this.field_259[3] == null) {
    ...
    public class_58[] method_232() {
        if ((this.field_178 & 32768L) != 0L) {
            ...
            if ((this.field_178 & 16384L) == 0L) {
                ...
                if (var1 > 1) {
                    ReferenceBinding.method_193(this.field_255, 0, var1);
                }
                this.field_178 |= 16384L;
            }
            var1 = 0;
                    ...
                    if (var6 != null) {
                        ...
                        for (int var9 = var4 + 1; var9 < var5; ++var9) {
                            ...
                            if (var10 != null) {
                                        ...
                                        if (var13 > 0) {
                                            ...
                                            while (true) {
                                                ...
                                                if (var11[var19] == var12[var19]) {
                                                    ...
                                                    if (var20 instanceof SourceTypeBinding && var20.method_181() != class_34.field_157) {
                                                        var19 = var13;
                                                        break;
                                                    }
                                                }
                                ...
                                AbstractMethodDeclaration var32 = var10.method_384();
                ...
                if (var2[var3].field_661 == var1) {
                    ...
                    try {
                        ...
                        if (!var8.method_147() || ((class_42)var8).field_192 != class_40.field_188) {
                            ...
                            if (var9 instanceof ReferenceBinding && (((ReferenceBinding)var9).field_199 & 1073741824) != 0) {
    ...
    public class_58 method_314(class_58 var1) {
        if ((var1.field_273 & 33554432) == 0) {
            ...
            AbstractMethodDeclaration var2 = var1.method_384();
            if (var2 == null) {
                return null;
            } else {
                ...
                if (var14 != null) {
                    var5 = var14.length;
                    var1.field_277 = new ReferenceBinding[var5];
                    int var6 = 0;
                    for (var8 = 0; var8 < var5; ++var8) {
                        ReferenceBinding var7 = (ReferenceBinding)var14[var8].method_1017(var2.field_478, true);
                        if (var7 != null) {
                            if (var7.method_149()) {
                    ...
                    if (var6 < var5) {
                        System.arraycopy(var1.field_277, 0, var1.field_277 = new ReferenceBinding[var6], 0, var6);
                    }
                }
                boolean var15 = false;
                ...
                if (var16 != null) {
                    ...
                    for (var9 = 0; var9 < var17; ++var9) {
                        ...
                        if (var11 == null) {
                            ...
                            if (var12 instanceof ReferenceBinding && (((ReferenceBinding)var12).field_199 & 1073741824) != 0) {
                ...
                if (!var1.method_358()) {
                    ...
                    if (var20 == null) {
                        ...
                        if (var21 == null) {
                            ...
                            if (var22 instanceof ReferenceBinding && (((ReferenceBinding)var22).field_199 & 1073741824) != 0) {
                                var1.field_273 |= 1073741824;
                            }
                        }
                    }
    ...
    void method_321(class_81 var1) {
        ...
        while (true) {
            ...
            ((SourceTypeBinding)this.field_256[var2]).method_321(var1);
        }
    }
}
