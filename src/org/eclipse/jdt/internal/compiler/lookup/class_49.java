...
import org.eclipse.jdt.internal.compiler.env.class_30;
import org.eclipse.jdt.internal.compiler.env.class_318;
import org.eclipse.jdt.internal.compiler.env.class_319;
...
public class class_49 extends class_43 {
    ...
    private class_46[] method_274(class_197 var1, boolean var2, char[][][] var3) {
            ...
            switch (var4[var10]) {
                ...
                default:
                    if (var9) {
                        ...
                        char[] var12 = CharOperation.method_1388(var4, var10, var11);
        ...
        class_46[] var14;
        var8.toArray(var14 = new class_46[var7]);
        if (var2) {
    ...
    public class_43 method_209(char[] var1) {
        ...
        while (true) {
            ...
            if (var3 instanceof class_44) {
                ...
                if (var4.length == var5 + var1.length && CharOperation.method_1368(var1, var4, var5, true)) {
                    return this.field_236[var2] = method_267(var3, this.field_238, false);
                }
            } else if (CharOperation.method_1364(var1, var3.field_198)) {
                return var3;
            }
        }
    }
