...
public class Logger {
    ...
    public Logger(Main var1, PrintStream var2, PrintStream var3) {
        this.field_932 = var1;
        this.field_928 = var2;
        this.field_926 = var3;
    ...
    private void method_1238(class_235 var1, char[] var2) {
        ...
        if (var3 <= var4 && (var3 >= 0 || var4 >= 0) && var5 > 0 && var4 <= var5) {
            ...
            this.field_929.put("value", class_329.field_1875);
    ...
    public int method_1251(class_235[] var1, char[] var2, Main var3) {
    ...
    private void method_1259(String var1) {
        eclipse.instance.method_737(var1);
    ...
    private void method_1264(char var1) {
        eclipse.instance.method_744(String.valueOf(var1));
    }
    ...
    public void method_1265() {
        ...
        if (var1) {
            class_342 var2 = this.field_932.batchCompiler.field_1702;
