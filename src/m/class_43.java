...
// $FF: renamed from: m.as
public abstract class class_43 extends class_40 implements class_18 {
    ...
    public static class_43 field_205;
    // $FF: renamed from: a g.f
    private static final class_10 field_206;
    // $FF: renamed from: b g.f
    private static final class_10 field_207;

    // $FF: renamed from: <init> () void
    public class_43() {
    }

    // $FF: renamed from: a (char[], m.k[]) m.k
    ...
    // $FF: renamed from: a (char[], m.ae[]) long
    ...
    // $FF: renamed from: a (m.k[], int, int) void
    public static void method_192(class_67[] var0, int var1, int var2) {
        class_316.method_3172(var0, var1, var2, field_206);
    }

    // $FF: renamed from: a (m.ae[], int, int) void
    public static void method_193(class_58[] var0, int var1, int var2) {
        class_316.method_3172(var0, var1, var2, field_207);
    }
    ...
    public final boolean method_194(class_38 var1) {
        return this.method_225() ? true : (this.method_223() ? false : var1 == this.field_200);
    }

    // $FF: renamed from: a (m.as, m.as) boolean
    public final boolean method_195(class_43 var1, class_43 var2) {
        if (this.method_225()) {
            return true;
            ...
            if (!this.method_223()) {
                ...
                if (var2 != this) {
                    ...
                    class_43 var5 = (class_43)this.method_138();
    ...
    // $FF: renamed from: a (m.bb) boolean
    public final boolean method_196(class_83 var1) {
        if (this.method_225()) {
            return true;
        } else {
            class_54 var2 = var1.method_585();
            if (var2 == this) {
                return true;
            } else if (var2 == null) {
    ...
    public final int method_199() {
        int var1 = 0;
        for (class_43 var2 = this; (var2 = var2.method_137()) != null; ++var1) {
            ;
        }
        return var1;
    }
            ...
            for (int var4 = var1.length; var3 < var4; ++var3) {
                ...
                if (this == var5) {
                    if (this instanceof class_54) {
                        ...
                        ((class_54)this).field_258.method_644().method_1467(this, this, var6 != null ? var6.field_497 : null);
                    }
                } else if (var5.method_145() && ((class_43)var5).method_200()) {
                    if (this instanceof class_54) {
                        var6 = (class_96)var1[var3].method_384();
                        ((class_54)this).field_258.method_644().method_1467(this, var5, var6 != null ? var6.field_497 : null);
                    }
                    var2 = true;
                }
            }
    ...
    // $FF: renamed from: a (int) m.as
    public final class_43 method_201(int var1) {
        class_43 var2;
    ...
    public boolean method_212(class_43 var1) {
        if (this == var1) {
                ...
                if (var6 != null && var6 != class_34.field_155) {
                    if (var2 == null) {
                        ...
                        if (var3 + var7 >= var2.length) {
                            System.arraycopy(var2, 0, var2 = new class_43[var3 + var7 + 5], 0, var3);
                        }
                        var8 = 0;
                        while (var8 < var7) {
                            class_43 var9 = var6[var8];
                            int var10 = 0;
                            while (true) {
                                if (var10 < var3) {
                                    if (var9 != var2[var10]) {
            ...
            for (int var12 = 0; var12 < var3; ++var12) {
                ...
                class_43[] var13 = var4.method_241();
                if (var13 != null && var13 != class_34.field_155) {
                    var8 = var13.length;
                    if (var3 + var8 >= var2.length) {
                        System.arraycopy(var2, 0, var2 = new class_43[var3 + var8 + 5], 0, var3);
                    }
                    int var14 = 0;
                    while (var14 < var8) {
                        class_43 var15 = var13[var14];
                        int var11 = 0;
                        while (true) {
                            if (var11 < var3) {
                                if (var15 != var2[var11]) {
    ...
    // $FF: renamed from: a (m.as, boolean) boolean
    public boolean method_215(class_43 var1, boolean var2) {
        if (this == var1) {
            return true;
        } else {
            class_43[] var3 = null;
                ...
                if (var6 != null && var6 != class_34.field_155) {
                    if (var3 == null) {
                        ...
                        if (var4 + var7 >= var3.length) {
                            System.arraycopy(var3, 0, var3 = new class_43[var4 + var7 + 5], 0, var4);
                        }
                        label80:
            ...
            for (int var12 = 0; var12 < var4; ++var12) {
                ...
                class_43[] var13 = var5.method_241();
                if (var13 != null && var13 != class_34.field_155) {
                    var8 = var13.length;
                    if (var4 + var8 >= var3.length) {
                        System.arraycopy(var3, 0, var3 = new class_43[var4 + var8 + 5], 0, var4);
                    }
                    int var14 = 0;
                    while (var14 < var8) {
                        class_43 var15 = var13[var14];
    ...
    boolean method_216(class_58 var1) {
        ...
        for (class_43 var3 = this; var3 != null; var3 = var3.method_240()) {
    ...
    public final class_43 method_233() {
        class_43 var1 = this;
        class_43 var2;
        do {
            var2 = var1;
    ...
    // $FF: renamed from: a (m.w, boolean) m.bg
    ...
    // $FF: renamed from: a (m.w, m.bg) void
    ...
    // $FF: renamed from: a (m.w, m.bf[]) void
    ...
    public class_43[] method_242() {
        if (this.method_226()) {
            ...
            return var1 == null ? null : new class_43[] {var1};
        }
    }
