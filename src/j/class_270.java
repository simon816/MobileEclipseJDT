...
public class class_270 {
    ...
    public class_270(boolean var1, boolean var2, boolean var3, long var4, long var6, char[][] var8, char[][] var9, boolean var10) {
        ...
        if (var8 != null) {
            ...
            if (var9 != null) {
                ...
                class_226.method_1326(var8, 0, var8.length - 1, var15);
                ...
                class_226.method_1325(var8, 0, var8.length - 1);
            }
                    ...
                    for (var9 = 0; var9 < this.field_1252.length; ++var9) {
                        ...
                        if (var10 != 0 && (!class_346.method_3335(var16[0]) || !class_346.method_3333(var5))) {
                            ...
                            if (var6 + var10 >= var2 || !class_346.method_3333(var3[var6 + var10 - 1]) || !class_346.method_3333(var3[var6 + var10])) {
                                ...
                                this.field_1248[this.field_1251] = class_233.field_994;
                                ++this.field_1251;
                                var6 += var10 - 1;
                                break;
                            }
            ...
            while (var17 < this.field_1251) {
                ...
                while (true) {
                    ...
                    if (var18 == var10) {
                        ...
                        while (class_233.method_1370(var3[var10]) && var18 <= var10) {
                            --var10;
                        }
                        while (class_233.method_1370(var3[var18]) && var18 <= var10) {
                            ++var18;
                        }
                ...
                while (true) {
                    ...
                    switch (this.field_1229) {
                        ...
                        default:
                            ...
                            if (var27 >= '\ud800' && var27 <= '\udbff') {
                                if (this.field_1224 < 3211264L) {
                                    var10000 = new class_232("Invalid_Unicode_Escape");
                                    throw var10000;
                                }
                                char var23 = (char)this.method_2413();
                                if (var23 < '\udc00' || var23 > '\udfff') {
                                    var10000 = new class_232("Invalid_Low_Surrogate");
                                    throw var10000;
                                }
                                ...
                                if (var27 >= '\udc00' && var27 <= '\udfff') {
                                    ...
                                    var10000 = new class_232("Invalid_High_Surrogate");
                                    throw var10000;
                                }
                        ...
                        case 34:
                            try {
                                        ...
                                        if (var24) {
                                            ...
                                            for (int var25 = 0; var25 < 50; ++var25) {
                                                ...
                                                if (this.field_1229 == 34) {
                                                    var10000 = new class_232("Invalid_Char_In_String");
                                                    throw var10000;
                                                }
                                            }
                                        } else {
                                ...
                                --this.field_1231;
                                var10000 = new class_232("Unterminated_String");
                                throw var10000;
                            } catch (class_232 var17) {
                        ...
                        case 39:
                            if ((var8 = this.method_2415('\n', '\r')) == 0) {
                                var10000 = new class_232("Invalid_Character_Constant");
                                throw var10000;
                            }
                            if (var8 > 0) {
                        ...
                        case 47:
                            ...
                            if (var8 == 0) {
                                ...
                                try {
                                    ...
                                    --this.field_1231;
                                    var10000 = new class_232("Unterminated_Comment");
                                    throw var10000;
                                }
                            }
                            break;
            ...
            while (true) {
                ...
                do {
                    ...
                    if ((this.field_1229 = this.field_1237[this.field_1231++]) == 92 && this.field_1237[this.field_1231] == 117) {
                        ...
                        var2 = class_233.method_1370(this.field_1229);
                    }
                } while (var2);
                boolean var4;
                switch (this.field_1229) {
                    ...
                    default:
                        try {
                            ...
                            if (var21 < 128) {
                                ...
                                if (var21 >= '\ud800' && var21 <= '\udbff') {
                                    if (this.field_1224 < 3211264L) {
                                        class_232 var10000 = new class_232("Invalid_Unicode_Escape");
                                        throw var10000;
                                    }
    ...
    private void method_2430() {
        ...
        if (var2 != var1) {
            ...
            int var8 = class_233.method_1373(field_1288, var15, true, var6, var5);
            if (var8 != -1) {
                ...
                int var10;
                for (; var8 != -1; var8 = class_233.method_1373(field_1288, var15, true, var10, var5)) {
                    int var9 = var8 + field_1289;
                    var10 = class_233.method_1375('$', var15, var9, var5);
                    if (var10 != -1) {
    ...
    public final void method_2436() throws class_232 {
        switch (this.field_1229) {
            ...
            default:
                ...
                class_232 var10000;
                if (var1 < 0 || var1 > 7) {
                    var10000 = new class_232("Invalid_Escape");
                    throw var10000;
                }
                boolean var2 = var1 > 3;
        ...
        if (!var1 && this.field_1229 == 48) {
            if (this.method_2415('x', 'X') >= 0) {
                ...
                if (this.method_2415('l', 'L') >= 0) {
                    if (var4 == var6) {
                        var10000 = new class_232("Invalid_Hexa_Literal");
                        throw var10000;
                    }
                    return 48;
                }
                ...
                if (this.method_2415('p', 'P') >= 0) {
                    ...
                    if (!class_346.method_3338(this.field_1229)) {
                        var10000 = new class_232("Invalid_Float_Literal");
                        throw var10000;
                    }
                    while (this.method_2416()) {
                        ;
    ...
    public final void method_2440(char[] var1) {
        int var2;
        if (var1 == null) {
            this.field_1237 = class_233.field_994;
            var2 = 0;
        } else {
